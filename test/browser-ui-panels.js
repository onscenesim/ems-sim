...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(output, 'desktop-notepad.png') });
    await page.locator('#crew-btn').click();
    await page.screenshot({ path: path.join(output, 'desktop-crew.png') });
    ...
    await page.screenshot({ path: path.join(output, 'desktop-medication.png') });
    await page.evaluate(() => {
      hideDrugPanel();
    ...
    await page.screenshot({ path: path.join(output, 'desktop-patient.png') });
    ...
    await page.screenshot({ path: path.join(output, 'mobile-light-crew.png') });
