...
function assembleSeedBlock(seed) {
  ...
  lines.push('  Adenosine 6 mg/2 mL, 12 mg/4 mL');
  lines.push('  Amiodarone 150 mg/3 mL');
  lines.push('  Aspirin 324 mg (also in jump bag)');
  lines.push('  Atropine 1 mg/10 mL');
  lines.push('  Calcium chloride 1 g/10 mL');
  lines.push('  Dextrose D50 25 g/50 mL; D10 250 mL bag');
  lines.push('  Diphenhydramine (Benadryl) 50 mg/mL');
  lines.push('  Dopamine 400 mg/250 mL (premixed)');
  lines.push('  Epinephrine 1:10,000 (1 mg/10 mL) — cardiac arrest/push-dose');
  lines.push('  Epinephrine 1:1,000 (1 mg/mL) — anaphylaxis IM/SQ');
  lines.push('  Fentanyl 100 mcg/2 mL');
  lines.push('  Glucagon 1 mg kit (powder + diluent)');
  lines.push('  Ketamine 500 mg/10 mL');
  lines.push('  Lidocaine 100 mg/5 mL');
  lines.push('  Magnesium sulfate 2 g/4 mL');
  ...
  lines.push('  Oral glucose gel (also in jump bag)');
  lines.push('  Oxytocin 20 units/mL');
  lines.push('  Sodium bicarbonate 50 mEq/50 mL');
  lines.push('  Thiamine 100 mg/mL');
  lines.push('  Tranexamic acid (TXA) 1 g/10 mL (if in protocol)');
  lines.push('  Vasopressin 20 units/mL');
  lines.push('  IV supplies: 14g, 16g, 18g, 20g, 22g, 24g catheters; NS 1 L and 500 mL bags; LR 1 L bags; macro/micro drip tubing; saline locks; pressure infuser bags');
  lines.push('');
  ...
  lines.push('11. EQUIPMENT CANON: Only reference equipment that appears in the UNIT EQUIPMENT manifest in this seed. NEVER invent equipment names. The cardiac monitor is called "the monitor" — NEVER "monitor bag." Equipment bags on this unit are: jump bag (general supplies), airway bag, drug bag (ALS meds), trauma bag, IO kit, and OB kit. The monitor is a standalone device, not a bag. Portable suction is a standalone device, not a bag.');
