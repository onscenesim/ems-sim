...
const INTERVENTIONS = [
  ...
  { id: "intubation", synonyms: ["intubate", "tube the patient", "get a tube", "oral intubation", "orotracheal intubation", "ETT", "endotracheal tube", "direct laryngoscopy", "video laryngoscopy", "glidescope", "macintosh blade", "miller blade", "definitive airway", "secure the airway", "place a tube", "place an airway", "advanced airway", "definitive airway management"], dc: [10,14], no_roll: false, dc_notes: "DC 10 normal airway. DC 14 difficult airway — trauma, obesity, blood, burns, angioedema, small mouth, short neck. Failure: describe resistance, poor view. Complication: esophageal placement — flat capnography waveform.", scope: "ALS - not available in urban california", notes: null },
