...
const INTERVENTIONS = [
  ...
  { id: "io_access", synonyms: ["intraosseous", "drill", "EZ-IO", "FAST1", "sternal IO", "tibial IO", "humeral IO", "bone drill", "get IO access", "IO access", "intraosseous access", "drill the tibia", "go IO", "do IO", "do an IO", "do the IO", "IO line", "establish IO", "place IO", "BIG", "bone injection gun", "humeral head IO", "humoral head IO", "humoral IO", "humoral", "proximal humerus IO", "humerus IO", "proximal tibia IO", "proximal tibial IO", "distal tibia IO", "tibial plateau IO", "IO"], dc: [7], no_roll: false, dc_notes: "DC 7. Failure: incorrect placement, inadequate depth. Complication: through-and-through, growth plate injury in pediatric. Always lower DC than peripheral IV — faster and more reliable in collapse.", scope: "ALS", notes: null },
  { id: "intubation", synonyms: ["intubate", "tube the patient", "get a tube", "oral intubation", "orotracheal intubation", "ETT", "endotracheal tube", "direct laryngoscopy", "video laryngoscopy", "glidescope", "macintosh blade", "miller blade", "definitive airway", "secure the airway", "place a tube", "place an airway", "advanced airway", "definitive airway management",
    // RSI is the same physical act (drug-assisted intubation), not a separate
    // procedure — one roll for the attempt. Prep vocabulary (preoxygenation,
    // cricoid pressure, apneic oxygenation) deliberately does NOT trigger it.
    "RSI", "rapid sequence intubation", "rapid sequence induction", "drug assisted intubation", "DAI", "pharmacologically assisted intubation", "PAI", "sedate and intubate", "paralyze and intubate", "ketamine and succinylcholine", "ketamine and roc", "delayed sequence intubation", "DSI", "ketamine dissociation intubation",
    // Airway-exchange phrasing — replacing a supraglottic with an ET tube IS an
    // intubation attempt (one roll). "it" variants cover "swap it for a tube"
    // when the igel was named earlier in the message or a prior turn.
    "swap it for a tube", "swap it for an ET tube", "swap it out for a tube", "swap it out for an ET tube", "switch it for a tube", "switch it for an ET tube", "switch it out for a tube", "switch it out for an ET tube", "swap igel for ET tube", "swap igel for a tube", "switch igel for ET tube", "swap out the igel for a tube", "swap supraglottic for ET tube", "swap SGA for ET tube", "swap king for ET tube", "swap LMA for ET tube", "exchange it for an ET tube", "exchange igel for ET tube", "exchange supraglottic for ET tube", "convert to an ET tube", "upgrade to an ET tube", "upgrade to a tube", "replace igel with ET tube", "replace it with an ET tube", "swap for an ET tube", "switch to an ET tube"], dc: [10,14], no_roll: false, dc_notes: "DC 10 normal airway. DC 14 difficult airway — trauma, obesity, blood, burns, angioedema, small mouth, short neck. If drug-assisted (RSI: sedation + paralytic first), paralysis improves first-pass odds but a failed attempt leaves an apneic patient — SpO2 falls immediately, narrate the developing rescue crisis (BVM, supraglottic, surgical airway). Failure: describe resistance, poor view. Complication: esophageal placement — flat capnography waveform.", scope: "ALS - not available in urban california", notes: null },
  ...
  { id: "needle_decompression", synonyms: ["needle D", "NCD", "needle decompression", "needle chest decompression", "bilateral needle decompression", "decompress the chest", "chest decompression", "tension pneumo treatment", "14 gauge needle", "second intercostal space", "midclavicular line", "anterior axillary line", "fifth intercostal", "needle thoracostomy", "thoracic decompression", "decompress", "chest needle", "needle the chest", "chest dart", "release the tension", "decomp the chest"], dc: [10], no_roll: false, dc_notes: "DC 10. Real-world miss rate is significant — a standard catheter often does not reach the pleura at the 2nd ICS. Failure: incorrect intercostal space, inadequate depth, no air rush. Complication: iatrogenic pneumothorax if no tension present, vascular injury. DC rises to 13 in obese patient.", scope: "ALS", notes: null },
  ...
  ], dc: [9], no_roll: false, dc_notes: "DC 9 — one roll covers capture, electrical and mechanical. Failure: pacing spikes march without capture — increase the output and reattempt. Marginal: capture achieved but tenuous — high output, intermittent capture, or minimal hemodynamic improvement; watch for loss of capture with movement. Complication: capture established then lost, or the patient reacts to pacing discomfort without sedation on board.", scope: "ALS - requires auth in some regions", notes: null },
  { id: "cpr", synonyms: [
  ...
  { id: "medication_push", synonyms: [
    ...
    "racemic epi", "racemic epinephrine", "epi 1:1000", "epi 1:10000", "epi",
    // Amiodarone
    ...
    // Pralidoxime
    "pralidoxime", "2-pam",
    // Rocuronium / Succinylcholine / Vecuronium (RSI drugs — giving a
    // paralytic is a med push; the intubation attempt is its own order)
    "rocuronium", "zemuron", "roc",
    "succinylcholine", "succs", "sux", "anectine",
  ...
  { id: "cricothyrotomy", synonyms: ["cric", "surgical cric", "surgical airway", "cricothyrotomy", "surgical cricothyrotomy", "front of neck access", "FONA", "emergency airway", "rescue airway", "cut the neck", "scalpel bougie tube", "scalpel-bougie cric", "percutaneous airway", "can't intubate can't oxygenate", "CICO rescue"], dc: [10], no_roll: false, dc_notes: "DC 10. A committed scalpel-bougie cricothyrotomy is reliable — more so than a difficult intubation; invasiveness is not failure rate. The cost is morbidity, not low odds. Failure: false passage, hemorrhage, inadequate airway. Complication: posterior tracheal wall perforation, subcutaneous emphysema. DC rises to 13 in a chemically burned or distorted airway.", scope: "ALS - not available in all regions, requires auth in some regions", notes: null },
  { id: "needle_cricothyrotomy", synonyms: ["needle cric", "needle cricothyrotomy", "needle cricothyroidotomy", "needle airway", "percutaneous needle airway", "jet insufflation", "jet ventilation", "transtracheal jet ventilation", "transtracheal jet insufflation", "transtracheal", "14 gauge angiocath cric", "14 gauge cric", "cannula cricothyrotomy", "needle jet ventilation"], dc: [13], no_roll: false, dc_notes: "DC 13 — higher than a surgical cric: in adults the cannula/jet technique is LESS reliable (DAS and most guidance favor scalpel), prone to kinking and inadequate ventilation. A temporizing oxygenation bridge, not definitive ventilation. Failure: kinking, false passage, no air entry. Complication: barotrauma/subcutaneous emphysema, inadequate CO2 clearance, cannula displacement. DC rises in distorted or burned airway.", scope: "ALS - not available in all regions, requires auth in some regions", notes: null },
  { id: "finger_thoracostomy", synonyms: ["finger thoracostomy", "finger thorac", "blunt dissection", "thoracostomy", "open thoracostomy", "finger sweep", "open the chest", "blunt chest entry", "fourth intercostal space", "fifth intercostal space", "anterior axillary line thoracostomy", "bilateral thoracostomies", "release the tension", "decompress with finger", "blunt dissection thoracostomy", "crack the chest", "chest entry", "open decompression", "convert to finger thoracostomy", "thoracic entry"], dc: [8], no_roll: false, dc_notes: "DC 8 — MORE reliable than needle decompression, not less: directly opening the pleura is near-definitive where a needle frequently misses. Lower DC reflects lower failure rate; the higher cost is invasiveness/morbidity, not odds. Failure: incorrect intercostal space, inadequate entry, failure to sweep. Complication: intercostal vessel injury, iatrogenic injury. Scope-limited procedure.", scope: "ALS - not available in all regions", notes: null },
  ...
  { id: "handoff_report", synonyms: ["give a report", "verbal report", "handoff", "SBAR", "MIST report", "ATMIST", "radio report", "patch report", "transfer of care report", "patient report", "give the ED a heads up", "notify the hospital", "call ahead report", "pre-arrival notification", "stroke alert", "trauma alert", "notify trauma surgery"], dc: null, no_roll: true, dc_notes: "No dice roll — logged event. Quality of report is evaluated in debrief. Timed event. STEMI/cath-lab activation routes to cath_lab_activation (its own logged event); stroke and trauma alerts generate separate logged timestamps here.", scope: "BLS", notes: null },
  ...
  dc_notes: "DC 11 — the roll reflects CONVERSION of SVT, not whether the maneuver was performed. Modified (REVERT) technique — blow into a 10ml syringe at 45 degrees, then immediately supine with passive leg raise — converts roughly 40% of SVT, well above strain-only valsalva (~17%); DC 11 matches that. SUCCESS: rhythm converts to sinus. FAILURE: still in SVT — a correct, well-coached attempt that simply did not convert, NOT a provider error; escalate to adenosine. No complication tier in an appropriate conscious patient.",
