...
const INTERVENTIONS = [
  ...
  { id: "cricothyrotomy", synonyms: ["cric", "surgical cric", "surgical airway", "cricothyrotomy", "surgical cricothyrotomy", "front of neck access", "FONA", "emergency airway", "rescue airway", "cut the neck", "scalpel bougie tube", "scalpel-bougie cric", "percutaneous airway", "can't intubate can't oxygenate", "CICO rescue"], dc: [14], no_roll: false, dc_notes: "DC 14. Always high — last resort procedure under extreme pressure, rarely practiced. Failure: false passage, hemorrhage, inadequate airway. Complication: posterior tracheal wall perforation, subcutaneous emphysema. DC rises to 17 in chemically burned or distorted airway.", scope: "ALS - not available in all regions, requires auth in some regions", notes: null },
  { id: "needle_cricothyrotomy", synonyms: ["needle cric", "needle cricothyrotomy", "needle cricothyroidotomy", "needle airway", "percutaneous needle airway", "jet insufflation", "jet ventilation", "transtracheal jet ventilation", "transtracheal jet insufflation", "transtracheal", "14 gauge angiocath cric", "14 gauge cric", "cannula cricothyrotomy", "needle jet ventilation"], dc: [12], no_roll: false, dc_notes: "DC 12. Cannula-over-needle puncture of the cricothyroid membrane for jet insufflation — a temporizing oxygenation bridge, not definitive ventilation. Failure: kinking, false passage, no air entry. Complication: barotrauma/subcutaneous emphysema, inadequate CO2 clearance, cannula displacement. DC rises in distorted or burned airway.", scope: "ALS - not available in all regions, requires auth in some regions", notes: null },
