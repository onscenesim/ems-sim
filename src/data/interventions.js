...
const INTERVENTIONS = [
  ...
  { id: "spinal_motion_restriction", synonyms: ["SMR", "spinal motion restriction", "spinal precautions", "manual stabilization", "hold the head", "in-line stabilization", "neutral alignment", "maintain alignment", "spinal immobilization", "backboard", "long spine board", "vacuum mattress", "rapid extrication", "maintain spinal precautions"], dc: [6], no_roll: false, dc_notes: "DC 6. Failure: inadequate immobilization, c-collar wrong size. Complication: airway compromise from collar in unconscious patient, worsening of injury during application. Reassess airway after collar application.", scope: "BLS", notes: null },
