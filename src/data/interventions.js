...
const INTERVENTIONS = [
  ...
  { id: "intubation", synonyms: ["intubate", "tube the patient", "get a tube", "oral intubation", "orotracheal intubation", "ETT", "endotracheal tube", "direct laryngoscopy", "video laryngoscopy", "glidescope", "macintosh blade", "miller blade", "definitive airway", "secure the airway", "place a tube", "place an airway", "advanced airway", "definitive airway management",
    ...
    "RSI", "rapid sequence intubation", "rapid sequence induction", "drug assisted intubation", "DAI", "pharmacologically assisted intubation", "PAI", "sedate and intubate", "paralyze and intubate", "ketamine and succinylcholine", "ketamine and roc", "delayed sequence intubation", "DSI", "ketamine dissociation intubation"], dc: [10,14], no_roll: false, dc_notes: "DC 10 normal airway. DC 14 difficult airway — trauma, obesity, blood, burns, angioedema, small mouth, short neck. If drug-assisted (RSI: sedation + paralytic first), paralysis improves first-pass odds but a failed attempt leaves an apneic patient — SpO2 falls immediately, narrate the developing rescue crisis (BVM, supraglottic, surgical airway). Failure: describe resistance, poor view. Complication: esophageal placement — flat capnography waveform.", scope: "ALS - not available in urban california", notes: null },
